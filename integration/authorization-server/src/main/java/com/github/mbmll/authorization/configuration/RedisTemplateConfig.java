...
import com.github.mbmll.authorization.serializer.Jackson2JsonRedisRegisteredClientSerializer;
...
public class RedisTemplateConfig {
	...
	public RedisTemplate<String, RegisteredClient> redisTemplateRegisteredClient(
		...
		// 可以使用读写JSON
		Jackson2JsonRedisRegisteredClientSerializer jackson2JsonRedisSerializer = new Jackson2JsonRedisRegisteredClientSerializer(
				redisObjectMapper());
	...
	public static ObjectMapper redisObjectMapper() {
		...
		// simpleModule.addDeserializer(ClientAuthenticationMethod.class, new
		// ClientAuthenticationMethodDeserializer());
		// simpleModule.addDeserializer(AuthorizationGrantType.class, new
		// AuthorizationGrantTypeDeserializer());
		// simpleModule.addDeserializer(ClientSettings.class, new
		// ClientSettingsDeserializer());
		// simpleModule.addDeserializer(TokenSettings.class, new
		// TokenSettingsDeserializer());
		// simpleModule.addDeserializer(OAuth2Authorization.class, new
		// OAuth2AuthorizationDeserializer());
		// simpleModule.addDeserializer(OAuth2AuthorizationConsent.class, new
		// OAuth2AuthorizationConsentDeserializer());
